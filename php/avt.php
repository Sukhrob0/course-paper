                      ...
                      <form class="mx-1 mx-md-4" action="login.php" method="post">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" placeholder="Логин" name="login" id="form3Example1c" class="form-control" style="border-color: #4a4d4b" />
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="password" placeholder="пароль" name="pass" id="form3Example4c" class="form-control" style="border-color: #4a4d4b"/>
                        ...
                        <div class="form-check d-flex justify-content-center mb-5">
                          ...
                          <label class="form-check-label" for="form2Example3">
                            Я согласен со всеми условиями <a href="#!">Условия предостовляемых услуг</a>
                          </label>
                        </div>
